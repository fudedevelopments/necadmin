...
class Proctor extends amplify_core.Model {
  ...
  const Proctor._internal({required this.id, proctorname, email, students, createdAt, updatedAt}): _proctorname = proctorname, _email = email, _students = students, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Proctor({String? id, String? proctorname, String? email, List<Student>? students}) {
  ...
  Proctor copyWith({String? proctorname, String? email, List<Student>? students}) {
    return Proctor._internal(
      id: id,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'proctorname': _proctorname, 'email': _email, 'students': _students?.map((Student? e) => e?.toJson()).toList(), 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
